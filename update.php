        ...
        <fieldset>
            ...
            <form action="actions/a_update.php"  method="post" enctype="multipart/form-data">
                <table class="table text-white">
                    <tr>
                        <th>Model</th>
                        <td><input class="form-control" type="text"  name="model" placeholder ="Product Name" value="<?php echo $name ?>"  /></td>
                    </tr>
                    <tr>
                        <th>Seats</th>
                        <td><input class="form-control" type= "number" name="seats" step="any"  placeholder="Seats" value ="<?php echo $seats ?>" /></td>
                    ...
                    <tr>
                        <th>Make</th>
                        <td><input class="form-control" type="year"  name="make" placeholder ="Make" value="<?php echo $make ?>"  /></td>
                    </tr>
                    <tr>
                        <th>Price</th>
